import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o,c as e,a as n,b as s,d as u,e as i}from"./app-1c6baea3.js";const c={},l=n("h1",{id:"星穹铁道抽卡记录标准-v1-0",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#星穹铁道抽卡记录标准-v1-0","aria-hidden":"true"},"#"),s(" 星穹铁道抽卡记录标准 v1.0")],-1),r=i(`<h2 id="json-示例" tabindex="-1"><a class="header-anchor" href="#json-示例" aria-hidden="true">#</a> Json 示例</h2><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
